...
import sys
sys.path.append("/home/sz/Web/TestWeb/")
...
def main(image_name):
    ...
    image_np.save('media/research/object_detection/test_images/result/'+name_result+'_result'+ext)
    ret = name_result + '_result' + ext
    return ret
